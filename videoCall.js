...
let toggleScreen = async(e) =>{
    ...
    if(!sharingScreen){
        ...
        document.getElementById('user-2').remove()
        displayFrame.style.display = 'block'

        let player = '<div id = "video1"> <video class = "video-player" id="user-2" autoplay playsinline></video></div>'

        displayFrame.insertAdjacentHTML('beforeend',player)
        document.getElementById('user-2').addEventListner('click',expandVideoFrame)

        localScreenTracks.play('user-2')
